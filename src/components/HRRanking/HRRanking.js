...
import "./_styles.scss";
import { WindowProgram, DetailsSection, ButtonIconLarge, ButtonForm, Button } from "packard-belle";
import Window from "../tools/Window";
import buildMenu from "../../helpers/menuBuilder";
// import siulunglung from '../../data/images/siulunglung.jpeg';
import BOK from "../../data/images/BOK.png";
                      ...
                      Object.entries(this.context.api.cachedvotes).sort((a, b) => { return b[1] - a[1]; }).slice(0, 5).map(([k, v], i) => {
                        return (
                          <div className="rank-wrapper">
                            <div className="rank">
                              <div className="counter">{v}</div>
                              <div className="avatar">
                                {this.state.actors[k] ? <img src={this.state.actors[k]['img'][0]} /> : <img src={"https://upload.cc/i1/2022/01/31/QJ4p6V.png"} />}
                              </div>
