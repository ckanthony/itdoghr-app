  ...
  props: "PayPayDuck & Born Hub", data: [{
    ...
    },
    {
      history: ["星之子",
        ...
        "人物原型：陳易希",], id: "llokmann", actor: "楊樂文", char: "星之子Tony", ig: "llokmann", img: [
    ...
    "性格負面",
    "於第2集加入Born Hub",
    "於第9集成功研發TouchWood應用程式",], id: "frankie", actor: "陳瑞輝", char: "常樂、Never", ig: "frankie729", img: [
...
},
{
  props: "九龍銀行 & 富三代", data: [{
    ...
    },
    {
      history: ["HR部阿姐",
        "於第1集由九龍銀行裁走裁葉念信",
        "第11集由九龍銀行裁走Lou Chui",], id: "ivyhkactress", actor: "彭珮嵐", char: "HR阿姐-你", ig: "ivy_hkactress", img: [
...
},
{
  ...
  { id: "ballfaiyau", actor: "波輝", char: "侍應", ig: "ballfaiyau", img: ["https://upload.cc/i1/2022/01/30/ChI5DF.png"], },
    {
    ...
    { history: ["派帖男",], id: "jimsiujim", actor: "英健朗", char: "派帖男", ig: "jimsiujim", img: ["https://upload.cc/i1/2022/01/30/0PUBMj.png"], },
    {
  ...
  { id: "zachary", actor: "翁煒桐", char: "侍應", ig: "zachary2ung", },]
},];
